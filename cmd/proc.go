...
var procCmd = &cobra.Command{
	...
	Long: `Manage background processes tracked by mdc.
Running "mdc proc" without a subcommand is equivalent to "mdc proc list".`,
...
func printProcTable(args []string) {
...
func init() {
	procCmd.AddCommand(procListCmd)
