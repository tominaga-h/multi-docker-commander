...
[![version](https://img.shields.io/badge/version-0.2.0-blue)](https://github.com/tominaga-h/multi-docker-commander/releases/tag/v0.2.0)
...
```bash
curl -L -o mdc https://github.com/tominaga-h/multi-docker-commander/releases/download/v0.2.0/mdc
chmod +x mdc
